 ...
 */
var SkipCommand = /** @class */ (function (_super) {
    __extends(SkipCommand, _super);
    function SkipCommand() {
        var _this = _super.call(this, 'skip', 'radio') || this;
        _this.lang = null;
        _this.lang = new ScopedLanguageHandler_1["default"]('commands.radio.skip');
    ...
    SkipCommand.prototype.execute = function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
            var queue, player, message, currentSong;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        message = 'Currently there is no song played that can be skipped';
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, interaction.reply({ content: currentSong.title + " skipped", ephemeral: true })];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
