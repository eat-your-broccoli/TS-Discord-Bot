 ...
 */
var Shorthand = /** @class */ (function () {
    function Shorthand(prefix, command) {
        this.prefix = prefix;
        this.command = command;
    }
    Shorthand.prototype.execute = function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.command.go(interaction)];
            });
        });
    };
    return Shorthand;
