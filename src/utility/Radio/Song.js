...
var createYtSteam_1 = require("./createYtSteam");
/**
...
var Song = /** @class */ (function () {
    ...
    Song.prototype.loadResource = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, createYtSteam_1["default"])(this.link)];
                    case 1:
                        stream = _a.sent();
    ...
    Song.fromYoutube = function (link) {
        return __awaiter(this, void 0, void 0, function () {
            var songInfo, song;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ytdl.getBasicInfo(link)];
                    case 1:
                        songInfo = _a.sent();
                        if (!songInfo)
